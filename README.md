...
### Prebuilt binaries
- Android [download apk](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-android-release-arm64-1.9.2.apk) or [download 32-bit apk](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-android-release-arm-1.9.2.apk)
- iOS [join via TestFlight](https://testflight.apple.com/join/6AkiEq09) or [download ipa](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-ios-release-arm64-1.9.2.ipa)
- Windows [download installer](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-mingw-win7-release-x86_64-1.9.2-system-installer.exe) or [download 32-bit installer](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-mingw-winxp-release-i686-1.9.2-system-installer.exe) [(require vc 2010 runtime)][vs2010_x86] or [download woa arm64 installer](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-mingw-release-aarch64-1.9.2-system-installer.exe)
- macOS [download intel dmg](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-macos-release-x64-1.9.2.dmg) or [download apple silicon dmg](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-macos-release-arm64-1.9.2.dmg)
- Linux [download rpm](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass.el7.x86_64.1.9.2-0.rpm) or [download deb](https://github.com/Chilledheart/yass/releases/download/1.9.2/yass-client-ubuntu-16.04-xenial_amd64.1.9.2.deb)

View more at [release page](https://github.com/Chilledheart/yass/releases/tag/1.9.2)
