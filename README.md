...
### Prebuilt binaries
- Android [download apk](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-android-release-arm64-1.7.4.apk) or [download 32-bit apk](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-android-release-arm-1.7.4.apk)
- iOS [join via TestFlight](https://testflight.apple.com/join/6AkiEq09) or [download ipa](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-ios-release-arm64-1.7.4.ipa)
- Windows [download installer](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-mingw-winxp-release-x86_64-1.7.4-system-installer.exe) or [download 32-bit installer (require runtime)](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-mingw-winxp-release-i686-1.7.4-system-installer.exe) or [download woa arm64 installer](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-mingw-release-aarch64-1.7.4-system-installer.exe)
- macOS [download intel dmg](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-macos-release-x64-1.7.4.dmg) or [download apple silicon dmg](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-macos-release-arm64-1.7.4.dmg)
- Linux [download rpm](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass.el7.x86_64.1.7.4-0.rpm) or [download deb](https://github.com/Chilledheart/yass/releases/download/1.7.4/yass-client-ubuntu-16.04-xenial_amd64.1.7.4.deb)

View more at [release page](https://github.com/Chilledheart/yass/releases/tag/1.7.4)
