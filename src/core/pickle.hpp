...
#ifndef CORE_PICKLE_H_
#define CORE_PICKLE_H_
...
class PickleIterator {
 public:
  ...
  // The absl::string_view data will only be valid for the lifetime of the message.
  bool ReadStringView(absl::string_view* result) WARN_UNUSED_RESULT;
  ...
  bool ReadData(span<const uint8_t>* data) WARN_UNUSED_RESULT;
...
class Pickle {
 public:
  ...
  void WriteString(const absl::string_view& value);
