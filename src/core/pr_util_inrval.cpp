...
#define LL_UDIVMOD(qp, rp, a, b)                                               \
  (*(qp) = ((uint64_t)(a) / (b)), *(rp) = ((uint64_t)(a) % (b)))
...
#define LL_CMP(a, op, b)                                                       \
  (((a).hi == (b).hi) ? ((a).lo op(b).lo) : ((int32_t)(a).hi op(int32_t)(b).hi))
#define LL_UCMP(a, op, b)                                                      \
  (((a).hi == (b).hi) ? ((a).lo op(b).lo) : ((a).hi op(b).hi))

#define LL_AND(r, a, b) ((r).lo = (a).lo & (b).lo, (r).hi = (a).hi & (b).hi)
#define LL_OR(r, a, b) ((r).lo = (a).lo | (b).lo, (r).hi = (a).hi | (b).hi)
#define LL_XOR(r, a, b) ((r).lo = (a).lo ^ (b).lo, (r).hi = (a).hi ^ (b).hi)
#define LL_OR2(r, a) ((r).lo = (r).lo | (a).lo, (r).hi = (r).hi | (a).hi)
#define LL_NOT(r, a) ((r).lo = ~(a).lo, (r).hi = ~(a).hi)

#define LL_NEG(r, a)                                                           \
  ((r).lo = -(int32_t)(a).lo, (r).hi = -(int32_t)(a).hi - ((r).lo != 0))
#define LL_ADD(r, a, b)                                                        \
  {                                                                            \
    int64_t _a, _b;                                                            \
    _a = a;                                                                    \
