...
#ifndef CORE_CONTAINERS_CHECKED_ITERATORS_H_
#define CORE_CONTAINERS_CHECKED_ITERATORS_H_
...
template <typename T>
struct __libcpp_is_contiguous_iterator<::CheckedContiguousIterator<T>>
    : true_type {};

template <typename T>
struct pointer_traits<::CheckedContiguousIterator<T>> {
  using pointer = ::CheckedContiguousIterator<T>;
  using element_type = T;
  using difference_type = ptrdiff_t;

  template <typename U>
  using rebind = ::CheckedContiguousIterator<U>;
...
#endif  // CORE_CONTAINERS_CHECKED_ITERATORS_H_
