...
#ifndef CORE_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
#define CORE_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
...
#endif  // CORE_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
