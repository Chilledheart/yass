...
#ifndef CORE_CONTAINERS_CONTIGUOUS_ITERATOR_H_
#define CORE_CONTAINERS_CONTIGUOUS_ITERATOR_H_
...
struct IsCheckedContiguousIter
    : disjunction<std::is_same<T, ::CheckedContiguousConstIterator<ValueT>>,
                  std::is_same<T, ::CheckedContiguousIterator<ValueT>>> {};
...
#endif  // CORE_CONTAINERS_CONTIGUOUS_ITERATOR_H_
