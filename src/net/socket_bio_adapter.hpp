...
#ifndef H_NET_SOCKET_BIO_ADAPTER
#define H_NET_SOCKET_BIO_ADAPTER
...
class SocketBIOAdapter {
 public:
  ...
  SocketBIOAdapter(asio::io_context *io_context,
 ...
 private:
  ...
  std::shared_ptr<IOBuf> read_buffer_;
  ...
  std::shared_ptr<IOBuf> write_buffer_;
...
#endif // H_NET_SOCKET_BIO_ADAPTER
