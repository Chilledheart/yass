...
inline Atomic32 Barrier_AtomicIncrement(volatile Atomic32* ptr,
                                        Atomic32 increment) {
  return gurl_base::WrappingAdd(((AtomicLocation32)ptr)->fetch_add(increment),
                           increment);
}
...
inline Atomic64 Barrier_AtomicIncrement(volatile Atomic64* ptr,
                                        Atomic64 increment) {
  return gurl_base::WrappingAdd(((AtomicLocation64)ptr)->fetch_add(increment),
                           increment);
}
