...
#define QUICHE_YASS_LOG_INFO VLOG(1)
...
#define QUICHE_YASS_DLOG_INFO DVLOG(1)
...
#define QUICHE_YASS_LOG_IF_INFO(condition) VLOG_IF(1, condition)
...
#define QUICHE_YASS_DLOG_IF_INFO(condition) DVLOG_IF(1, condition)
