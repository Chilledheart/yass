...
class StringPieceReplacements : public Replacements<CharT> {
 ...
 public:
  ...
  void SetPasswordStr(absl::string_view str) { SetImpl(&ParentT::SetPassword, str); }
