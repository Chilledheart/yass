...
class GURL {
 public:
  ...
  explicit GURL(absl::string_view url_string);
  ...
  GURL Resolve(absl::string_view relative) const;
  ...
  // colon.
  bool SchemeIs(absl::string_view lower_ascii_scheme) const;
  ...
  static bool SchemeIsCryptographic(absl::string_view lower_ascii_scheme);
  ...
  absl::string_view scheme_piece() const {
  ...
  absl::string_view username_piece() const {
  ...
  absl::string_view password_piece() const {
  ...
  absl::string_view host_piece() const {
  ...
  absl::string_view port_piece() const {
  ...
  absl::string_view path_piece() const {
  ...
  absl::string_view query_piece() const {
  ...
  absl::string_view ref_piece() const {
  ...
  absl::string_view PathForRequestPiece() const;
  ...
  absl::string_view HostNoBracketsPiece() const;
  ...
  bool DomainIs(absl::string_view canonical_domain) const;
  ...
  static bool IsAboutPath(absl::string_view actual_path,
                          absl::string_view allowed_path);
 ...
 private:
  ...
  bool IsAboutUrl(absl::string_view allowed_path) const;
  ...
  absl::string_view ComponentStringPiece(const url::Component& comp) const {
    if (comp.len <= 0)
      return absl::string_view();
    return absl::string_view(&spec_[comp.begin], comp.len);
  }
...
bool operator==(const GURL& x, const absl::string_view& spec);
bool operator==(const absl::string_view& spec, const GURL& x);
bool operator!=(const GURL& x, const absl::string_view& spec);
bool operator!=(const absl::string_view& spec, const GURL& x);
