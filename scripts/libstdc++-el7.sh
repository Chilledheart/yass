...
curl -L -O -4 --retry 30  http://mirror.centos.org/centos/7/sclo/x86_64/rh/Packages/d/devtoolset-11-libstdc++-devel-11.2.1-9.1.el7.x86_64.rpm

rpm2cpio devtoolset-11-libstdc++-devel-11.2.1-9.1.el7.x86_64.rpm | cpio -idvm
